...
class ProblemaCCppCaso extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = 'App\ProblemaCCppCaso';
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Textarea::make("Input","input")->hideFromIndex(),
            Textarea::make("Output","output")->hideFromIndex(),
